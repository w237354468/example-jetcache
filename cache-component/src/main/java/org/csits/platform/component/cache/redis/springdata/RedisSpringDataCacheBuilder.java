 ...
 */
public class RedisSpringDataCacheBuilder<T extends ExternalCacheBuilder<T>> extends
    ExternalCacheBuilder<T> {
    ...
    public static class RedisSpringDataCacheBuilderImpl extends
